<x-app-layout>
    ...
    <section class=" sm:flex sm:items-end sm:justify-between pt-4 pb-10">
        ...
        <div class=" py-3 sm:py-0">
            <x-link-button href="/search">Start Exploring</x-link-button>
        </div>
    </section>

    <section class=" sm:grid sm:grid-cols-[2fr_1fr] sm:gap-4">
        <div>
            <div class="rounded-xl bg-slate-300 aspect-video transition-all">
                <img src="" alt="" class="object-cover w-full">
            </div>
            <div class=" sm:hidden my-2 transition-all">
        ...
        <div class=" sm:flex sm:flex-col sm:justify-between">
            <div class=" hidden sm:block transition-all">
                <h2 class="text-3xl text-color-title">Tilte title title</h2>
                <p class="text-color-sub-title">Description decription decription decription</p>
            </div>
            <div class=" flex items-center justify-between">
                <div class=" flex items-center">
                    <div class=" w-6 h-2 mx-1 bg-color-primary rounded-md transition-all"></div>
                    <div class=" w-2 h-2 mx-1 bg-color-secondary rounded-md transition-all"></div>
                    <div class=" w-2 h-2 mx-1 bg-color-secondary rounded-md transition-all"></div>
                </div>
                <div class=" flex items-center">
                    <button
                        class=" p-1 mx-1 rounded-full border-2 border-color-primary hover:bg-color-primary hover:text-color-bg rotate-90 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class=" hover:text-color-bg text-color-primary icon icon-tabler icons-tabler-outline icon-tabler-arrow-down">
                ...
                <div class="flex items-center mb-1">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            ...
                            class="text-color-primary icon icon-tabler icons-tabler-outline icon-tabler-heart">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                            class="text-color-primary icon icon-tabler icons-tabler-outline icon-tabler-message-2">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M8 9h8" />
                            <path d="M8 13h6" />
                            <path
